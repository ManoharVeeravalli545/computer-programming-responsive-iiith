...
window.view = {
	...
	// drawFillRectangle: draws fill rectangle on canvasContext.
 	drawFillRectangle: function () {
 		...
 		this.canvasContext.fillRect (50, 50, 250, 250);
 		this.canvasContext.strokeStyle = '#000000';
 		this.canvasContext.rect(50, 50, 250, 250);
 	...
 	// displayText: draws given text on canvasContext according given x and y coordinates.
		...
		this.drawCircle(300, 50, '#000000');
		this.drawCircle(300, 300, '#000000');
		this.drawCircle(50, 300, '#000000');
		this.displayText('(x1, y1)', 50, 50); 
		this.displayText('(x2, y2)', 300, 50);
		this.displayText('(x3, y3)', 300, 300);
